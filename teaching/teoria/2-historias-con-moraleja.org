#+title: La Fábula de las Banderas: El ABC de la Exclusión Mutua
#+date: 2026-02-27
#+filetags: :teoria:algoritmos:exclusion-mutua:alice-bob:
...
[[file:../../images/cat_dog_safety.jpg]]
...
Esta nota sigue de cerca el Capítulo 1 de:

#+begin_quote
Maurice Herlihy y Nir Shavit. /The Art of Multiprocessor Programming/.
Morgan Kaufmann Publishers, San Francisco, 2008. ISBN 0-12-370591-6.
Capítulo 1, /Introduction/ (§1.1, /Shared Objects and Synchronization/).
#+end_quote

La historia de Alice, Bob y sus mascotas, el protocolo de banderas y el análisis
de exclusión mutua, deadlock, inanición y tolerancia a fallos provienen de ahí;
aquí se cuentan en español y con algunos comentarios añadidos para el curso.

El libro aparece también en la [[file:../practicas/referencias.html][bibliografía del curso]], donde puedes descargar
la entrada en formato BibTeX.

* Notas relacionadas

- [[file:1-intro-que-porque-paraque.org][¿Qué es la concurrencia? Origen, propósito y definición]]
- [[file:nocionesDcorrecion.org][Distintos sabores de corrección: ¿cómo evitar el choque de mascotas?]]